...
{ "ER_BAD_SLAVE", 1200, "The server is not configured as slave; fix with CHANGE MASTER TO" },
...
{ "ER_WARN_DEPRECATED_SYNTAX", 1287, "\'%s\' is deprecated; use \'%s\' instead" },
...
{ "ER_STACK_OVERRUN_NEED_MORE", 1436, "Thread stack overrun:  %ld bytes used of a %ld byte stack, and %ld bytes needed.  Use \'mysqld -O thread_stack=#\' to specify a bigger stack." },
...
{ "ER_TABLE_NEEDS_UPGRADE", 1459, "Table upgrade required. Please do \"REPAIR TABLE `%-.32s`\" to fix it!" },
...
{ "ER_CONST_EXPR_IN_PARTITION_FUNC_ERROR", 1486, "Constant/Random expression in (sub)partitioning function is not allowed" },
...
{ "ER_BINLOG_UNSAFE_STATEMENT", 1592, "Statement is not safe to log in statement format." },
...
{ "ER_SLAVE_AMBIGOUS_EXEC_MODE", 1608, "Ambiguous slave modes combination. %s" },
...
{ "ER_WARN_AUTO_CONVERT_LOCK", 1630, "Converted to non-transactional lock on \'%-.64s\'" },
{ "ER_NO_AUTO_CONVERT_LOCK_STRICT", 1631, "Cannot convert to non-transactional lock in strict mode on \'%-.64s\'" },
{ "ER_NO_AUTO_CONVERT_LOCK_TRANSACTION", 1632, "Cannot convert to non-transactional lock in an active transaction on \'%-.64s\'" },
{ "ER_NO_STORAGE_ENGINE", 1633, "Can\'t access storage engine of table %-.64s" },
{ "ER_BACKUP_BACKUP_START", 1634, "Starting backup process" },
{ "ER_BACKUP_BACKUP_DONE", 1635, "Backup completed" },
{ "ER_BACKUP_RESTORE_START", 1636, "Starting restore process" },
{ "ER_BACKUP_RESTORE_DONE", 1637, "Restore completed" },
{ "ER_BACKUP_NOTHING_TO_BACKUP", 1638, "Nothing to backup" },
{ "ER_BACKUP_CANNOT_INCLUDE_DB", 1639, "Database \'%-.64s\' cannot be included in a backup" },
{ "ER_BACKUP_BACKUP", 1640, "Error during backup operation - see SHOW WARNINGS for more information" },
{ "ER_BACKUP_RESTORE", 1641, "Error during restore operation - see SHOW WARNINGS for more information" },
{ "ER_BACKUP_RUNNING", 1642, "Can\'t execute this command because another BACKUP/RESTORE operation is in progress" },
{ "ER_BACKUP_BACKUP_PREPARE", 1643, "Error when preparing for backup operation" },
{ "ER_BACKUP_RESTORE_PREPARE", 1644, "Error when preparing for restore operation" },
{ "ER_BACKUP_INVALID_LOC", 1645, "Invalid backup location \'%-.64s\'" },
{ "ER_BACKUP_READ_LOC", 1646, "Can\'t read backup location \'%-.64s\'" },
{ "ER_BACKUP_WRITE_LOC", 1647, "Can\'t write to backup location \'%-.64s\'" },
{ "ER_BACKUP_LIST_DBS", 1648, "Can\'t enumerate server databases" },
{ "ER_BACKUP_LIST_TABLES", 1649, "Can\'t enumerate server tables" },
{ "ER_BACKUP_LIST_DB_TABLES", 1650, "Can\'t enumerate tables in database %-.64s" },
{ "ER_BACKUP_SKIP_VIEW", 1651, "Skipping view %-.64s in database %-.64s" },
{ "ER_BACKUP_NO_ENGINE", 1652, "Skipping table %-.64s since it has no valid storage engine" },
{ "ER_BACKUP_TABLE_OPEN", 1653, "Can\'t open table %-.64s" },
{ "ER_BACKUP_READ_HEADER", 1654, "Can\'t read backup archive preamble" },
{ "ER_BACKUP_WRITE_HEADER", 1655, "Can\'t write backup archive preamble" },
{ "ER_BACKUP_NO_BACKUP_DRIVER", 1656, "Can\'t find backup driver for table %-.64s" },
{ "ER_BACKUP_NOT_ACCEPTED", 1657, "%-.64s backup driver was selected for table %-.64s but it rejects to handle this table" },
{ "ER_BACKUP_CREATE_BACKUP_DRIVER", 1658, "Can\'t create %-.64s backup driver" },
{ "ER_BACKUP_CREATE_RESTORE_DRIVER", 1659, "Can\'t create %-.64s restore driver" },
{ "ER_BACKUP_TOO_MANY_IMAGES", 1660, "Backup image uses %d backup engines but maximum %d are supported" },
{ "ER_BACKUP_WRITE_META", 1661, "Error when saving meta-data of %-.64s" },
{ "ER_BACKUP_READ_META", 1662, "Error when reading meta-data" },
{ "ER_BACKUP_CREATE_META", 1663, "Failed to obtain meta-data for %-.64s" },
{ "ER_BACKUP_GET_BUF", 1664, "Can\'t allocate buffer for image data transfer" },
{ "ER_BACKUP_WRITE_DATA", 1665, "Error when writing data from %-.64s backup driver (data block for table #%d)" },
{ "ER_BACKUP_READ_DATA", 1666, "Error when reading data from backup stream" },
{ "ER_BACKUP_NEXT_CHUNK", 1667, "Can\'t go to the next chunk in backup stream" },
{ "ER_BACKUP_INIT_BACKUP_DRIVER", 1668, "Can\'t initialize %-.64s backup driver" },
{ "ER_BACKUP_INIT_RESTORE_DRIVER", 1669, "Can\'t initialize %-.64s restore driver" },
{ "ER_BACKUP_STOP_BACKUP_DRIVER", 1670, "Can\'t shut down %-.64s backup driver" },
{ "ER_BACKUP_STOP_RESTORE_DRIVERS", 1671, "Can\'t shut down %-.64s restore driver(s)" },
{ "ER_BACKUP_PREPARE_DRIVER", 1672, "%-.64s backup driver can\'t prepare for synchronization" },
{ "ER_BACKUP_CREATE_VP", 1673, "%-.64s backup driver can\'t create its validity point" },
{ "ER_BACKUP_UNLOCK_DRIVER", 1674, "Can\'t unlock %-.64s backup driver after creating the validity point" },
{ "ER_BACKUP_CANCEL_BACKUP", 1675, "%-.64s backup driver can\'t cancel its backup operation" },
{ "ER_BACKUP_CANCEL_RESTORE", 1676, "%-.64s restore driver can\'t cancel its restore operation" },
{ "ER_BACKUP_GET_DATA", 1677, "Error when polling %-.64s backup driver for its data" },
{ "ER_BACKUP_SEND_DATA", 1678, "Error when sending data (for table #%d) to %-.64s restore driver" },
{ "ER_BACKUP_SEND_DATA_RETRY", 1679, "After %d attempts %-.64s restore driver still can\'t accept next block of data" },
{ "ER_BACKUP_OPEN_TABLES", 1680, "Open and lock tables failed in %-.64s" },
{ "ER_BACKUP_THREAD_INIT", 1681, "Backup driver\'s table locking thread can not be initialized." },
{ "ER_BACKUP_PROGRESS_TABLES", 1682, "Can\'t open the backup logs as tables. Check \'mysql.backup_history\' and \'mysql.backup_progress\' or run mysql_upgrade to repair." },
{ "ER_TABLESPACE_EXIST", 1683, "Tablespace \'%-.192s\' already exists" },
{ "ER_NO_SUCH_TABLESPACE", 1684, "Tablespace \'%-.192s\' doesn\'t exist" },
{ "ER_SLAVE_IGNORE_SERVER_IDS", 1685, "The requested server id %d clashes with the slave startup option --replicate-same-server-id" },
{ "ER_BACKUP_CANT_FIND_SE", 1686, "Backup image contains data created by a native driver of %-.64s storage engine but this engine can not be found on this server" },
{ "ER_BACKUP_NO_NATIVE_BE", 1687, "Backup image contains data created by a native driver of %-.64s storage engine but it has no native backup support on this server" },
{ "ER_BACKUP_UNKNOWN_BE", 1688, "Backup engine #%d needed for restoring from backup image has unknown type" },
{ "ER_BACKUP_WRONG_TABLE_BE", 1689, "Backup image specifies wrong backup engine #%d for one of the tables" },
{ "ER_BACKUP_CANT_RESTORE_DB", 1690, "Could not restore database %-.64s" },
{ "ER_BACKUP_CANT_RESTORE_TABLE", 1691, "Could not restore table %-.64s" },
{ "ER_BACKUP_CANT_RESTORE_VIEW", 1692, "Could not restore view %-.64s. Please check the view definition for possible missing dependencies." },
{ "ER_BACKUP_CANT_RESTORE_SROUT", 1693, "Could not restore stored routine %-.64s" },
{ "ER_BACKUP_CANT_RESTORE_EVENT", 1694, "Could not restore event %-.64s" },
{ "ER_BACKUP_CANT_RESTORE_TRIGGER", 1695, "Could not restore trigger %-.64s" },
{ "ER_BACKUP_CATALOG_ADD_DB", 1696, "Failed to add database `%-.64s` to the catalog" },
{ "ER_BACKUP_CATALOG_ADD_TABLE", 1697, "Failed to add table `%-.64s`.`%-.64s` to the catalog" },
{ "ER_BACKUP_CATALOG_ADD_VIEW", 1698, "Failed to add view `%-.64s`.`%-.64s` to the catalog" },
{ "ER_BACKUP_CATALOG_ADD_SROUT", 1699, "Failed to add stored routine `%-.64s`.`%-.64s` to the catalog" },
{ "ER_BACKUP_CATALOG_ADD_EVENT", 1700, "Failed to add event `%-.64s`.`%-.64s` to the catalog" },
{ "ER_BACKUP_CATALOG_ADD_TRIGGER", 1701, "Failed to add trigger `%-.64s`.`%-.64s` to the catalog" },
{ "ER_BACKUP_UNKNOWN_OBJECT", 1702, "Backup image refers to an object which could not be found in the catalog" },
{ "ER_BACKUP_UNKNOWN_OBJECT_TYPE", 1703, "Backup image refers to an object of unknown type" },
{ "ER_BACKUP_OPEN_WR", 1704, "Cannot open backup stream for writing" },
{ "ER_BACKUP_OPEN_RD", 1705, "Cannot open backup stream for reading" },
{ "ER_BACKUP_BAD_MAGIC", 1706, "Could not find correct signature at the beginning of backup stream" },
{ "ER_BACKUP_CONTEXT_CREATE", 1707, "Cannot create backup/restore execution context" },
{ "ER_BACKUP_CONTEXT_REMOVE", 1708, "Error when cleaning up after backup/restore operation" },
{ "ER_BAD_PATH", 1709, "Malformed file path \'%-128s\'" },
{ "ER_DDL_BLOCK", 1710, "Erorr when attempting to block DDLs" },
{ "ER_BACKUP_LOGGER_INIT", 1711, "Could not initialize logging and reporting services" },
{ "ER_BACKUP_WRITE_SUMMARY", 1712, "Error when writing summary section of backup image" },
{ "ER_BACKUP_READ_SUMMARY", 1713, "Error when reading summary section of backup image" },
{ "ER_BACKUP_GET_META_DB", 1714, "Failed to obtain meta-data for database %-.64s" },
{ "ER_BACKUP_GET_META_TABLE", 1715, "Failed to obtain meta-data for table %-.64s" },
{ "ER_BACKUP_GET_META_VIEW", 1716, "Failed to obtain meta-data for view %-.64s" },
{ "ER_BACKUP_GET_META_SROUT", 1717, "Failed to obtain meta-data for stored routine %-.64s" },
{ "ER_BACKUP_GET_META_EVENT", 1718, "Failed to obtain meta-data for event %-.64s" },
{ "ER_BACKUP_GET_META_TRIGGER", 1719, "Failed to obtain meta-data for trigger %-.64s" },
{ "ER_BACKUP_CREATE_BE", 1720, "Cannot create backup engine for storage engine %-.64s" },
{ "ER_BACKUP_LIST_PERDB", 1721, "Can\'t enumerate per database objects" },
{ "ER_BACKUP_LIST_DB_VIEWS", 1722, "Can\'t enumerate views in database `%-.64s`" },
{ "ER_BACKUP_LIST_DB_SROUT", 1723, "Can\'t enumerate stored routines in database `%-.64s`" },
{ "ER_BACKUP_LIST_DB_EVENTS", 1724, "Can\'t enumerate events in database `%-.64s`" },
{ "ER_BACKUP_LIST_DB_TRIGGERS", 1725, "Can\'t enumerate triggers in database `%-.64s`" },
{ "ER_BACKUP_LOG_WRITE_ERROR", 1726, "Can\'t write to the online backup progress log %-.64s." },
{ "ER_TABLESPACE_NOT_EMPTY", 1727, "Tablespace \'%-.192s\' not empty" },
{ "ER_BACKUP_CAT_ENUM", 1728, "Could not access the contents of the backup catalog when writing backup image preamble" },
{ "ER_BACKUP_CANT_RESTORE_TS", 1729, "Could not create tablespace %-.64s needed by tables being restored." },
{ "ER_BACKUP_TS_CHANGE", 1730, "Tablespace %-.64s needed by tables being restored, but the current tablespace definition differs from how it was when backup was made." },
{ "ER_BACKUP_GET_META_TS", 1731, "Failed to obtain meta-data for tablespace %-.64s." },
{ "ER_TABLESPACE_DATAFILE_EXIST", 1732, "Tablespace data file \'%-.192s\' already exists" },
{ "ER_BACKUP_CATALOG_ADD_TS", 1733, "Failed to add tablespace `%-.64s` to the catalog" },
...
{ "ER_BACKUP_FAILED_TO_INIT_COMPRESSION", 1736, "Could not initialize compression of backup image (function deflateInit2 returned error code %d: %-.64s)" },
{ "ER_BACKUP_OBTAIN_NAME_LOCK_FAILED", 1737, "Restore failed to obtain the name locks on the tables." },
{ "ER_BACKUP_RELEASE_NAME_LOCK_FAILED", 1738, "Restore failed to release the name locks on the tables." },
{ "ER_BACKUP_BACKUPDIR", 1739, "The path specified for the system variable backupdir cannot be accessed or is invalid. ref: %-.64s" },
{ "ER_DDL_TIMEOUT", 1740, "The backup wait timeout has expired for query \'%-64s\'." },
{ "ER_BACKUP_LIST_DB_PRIV", 1741, "Can\'t enumerate grants in database \'%-.64s\'." },
{ "ER_BACKUP_CATALOG_ADD_PRIV", 1742, "Failed to add grant \'%-.64s\' to the catalog" },
{ "ER_BACKUP_GET_META_PRIV", 1743, "Failed to obtain meta-data for grant \'%-.64s\'." },
{ "ER_BACKUP_CANT_RESTORE_PRIV", 1744, "Could not execute grant \'%-.64s\'." },
{ "ER_BACKUP_GRANT_SKIPPED", 1745, "The grant \'%-.64s\' for the user %-.64s was skipped because the user does not exist." },
{ "ER_BACKUP_GRANT_WRONG_DB", 1746, "The grant \'%-.64s\' failed. Database not included in the backup image." },
{ "ER_BACKUP_LOGPATHS", 1747, "The log names for backup_history and backup_progress must be unique." },
{ "ER_BACKUP_LOGPATH_INVALID", 1748, "The path specified for the %-.64s is invalid. ref: %-.64s" },
{ "ER_BACKUP_SEND_REPLY", 1749, "Failed to send reply to client after successful %-.64s operation" },
...
{ "ER_BACKUP_LOG_OUTPUT", 1752, "Removing backup log entries by date or backup_id requires logging to tables." },
{ "ER_BACKUP_PURGE_DATETIME", 1753, "The datetime specified is invalid for the \'%-.64s\' command." },
{ "ER_BACKUP_LOGS_DELETED", 1754, "Backup log entries deleted: " },
{ "ER_BACKUP_LOGS_TRUNCATED", 1755, "All backup log entries have been deleted" },
{ "ER_MASTER_BLOCKING_SLAVES", 1756, "The master is not allowing slave connections." },
{ "ER_RESTORE_ON_MASTER", 1757, "A restore operation was initiated on the master." },
{ "ER_RESTORE_ON_SLAVE", 1758, "A restore operation was attempted on a slave during replication. You must stop the slave prior to running a restore." },
{ "ER_NONUNIQ_DB", 1759, "Not unique database: \'%-.192s\'" },
{ "ER_RESTORE_DB_EXISTS", 1760, "Database \'%-.64s\' already exists. Use OVERWRITE flag to overwrite." },
{ "ER_QUERY_CACHE_DISABLED", 1761, "Query cache is disabled; restart the server with query_cache_type=1 to enable it" },
{ "ER_BACKUP_UNEXPECTED_DATA", 1762, "Backup image contains no tables, but table data was found in it" },
...
{ "ER_RESTORE_CANNOT_START_SLAVE", 1767, "Cannot start slave. SLAVE START is blocked by %-.64s." },
{ "ER_OPERATION_ABORTED", 1768, "Operation aborted" },
{ "ER_OPERATION_ABORTED_CORRUPTED", 1769, "Operation aborted - data might be corrupted" },
...
{ "ER_RESIGNAL_WITHOUT_ACTIVE_HANDLER", 1774, "RESIGNAL when handler not active" },
{ "ER_SIGNAL_BAD_CONDITION_TYPE", 1775, "SIGNAL/RESIGNAL can only use a CONDITION defined with SQLSTATE" },
